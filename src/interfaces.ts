...
type ReloadContinuation = NarrowableKeyedItems<ContinuationKeys, {
  reloadContinuationData: {
    continuation: string
  }
}>
...
type Continuations = LiveContinuations | LiveReplayContinuations
...
type ReplayChatItemAction = NarrowableKeyedItems<ChatActionKeys, {
  replayChatItemAction: {
...
type Actions = AddLiveChatTickerItemAction | AddChatItemAction | ReplayChatItemAction
